 ...
 */
public abstract class GetJsonArrayWithoutDialog extends AsyncTask<String,Void,JSONArray> implements CallbackReciever {
    private String key;

    public GetJsonArrayWithoutDialog(String key) {
        this.key = key;
    }
