...
/**
 * Created by kyler on 21/04/2016.
 */
public abstract class PostDataWithoutDialog extends AsyncTask<String,Void,JSONObject> implements CallbackReciever {
    private JSONObject jsonObject;

    public abstract void receiveData(Object result);

    public PostDataWithoutDialog(JSONObject jsonObject) {
